...
st_lottie(load_lottie_file("src/animations/learning.json"))
...
st_lottie(load_lottie_file("src/animations/teamwork.json"))
...
st_lottie(load_lottie_file("src/animations/climb.json"))
